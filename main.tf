...
module "folder" {
  source = "git@github.com-renauto:Sofiane-Truman/fast-modules.git//folder?ref=main"
  folder_create = false
...
module "project" {
  source = "git@github.com-renauto:Sofiane-Truman/fast-modules.git//project?ref=main"
